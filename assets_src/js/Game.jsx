...
export default class Game extends React.Component {
  constructor(props) {
    ...
    if(debug) {
      ...
      this.state = {
        beans: Model.beans,
        bean_plants: Model.bean_plants,
        bean_plant_level: Model.bean_plant_level,
        bps: Model.bps,
        bean_extract: Model.bean_extract,
        bean_potion: Model.bean_potion,
        red_bean_potions: Model.red_bean_potions,
        green_bean_potions: Model.green_bean_potions,
        blue_bean_potions: Model.blue_bean_potions,
        black_bean_potions: Model.black_bean_potions,
        mystery_bean_potions: Model.mystery_bean_potions,
      }
    }
  }
  ...
  downgradeCollector(collector, rate) {
    this.setState((prevState) => ({
      [collector]: (prevState[collector] - rate)
    }))
  }
...
<section className="upgrades">
  { this.state.bean_plants !== null &&
    <div>
      ...
      <UpgradeGroup
        upgrade={() => {this.upgradeCollector('bean_plant_level', 0.05)}}
        downgrade={() => {this.downgradeCollector('bean_plant_level', 0.05)}}
        canUpgrade={() => {this.decrementValue(100, 'beans')}}
